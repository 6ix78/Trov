                            ...
                            <ul class="link-list-opt no-bdr">
                              <li>
                                <a
                                  ...
                                  class="wd-new-account"
                                  data-action="https://app.investorm.xyz/withdraw/account/paypal"
                                  data-modal="wdm-account"
                                >
                              ...
                              <li>
                                <a
                                  href="javascript:void(0)"
                                  class="wd-new-account"
                                  data-action="https://app.investorm.xyz/withdraw/account/crypto-withdraw"
                                  data-modal="wdm-account"
                                >
                                  <em class="icon bx bx-wallet"></em>
                              ...
                              <li>
                                <a
                                  href="javascript:void(0)"
                                  class="wd-new-account"
                                  data-action="https://app.investorm.xyz/withdraw/account/bank"
                                  data-modal="wdm-account"
                                >
                      ...
                      <div class="data-item">
                        <div class="data-col">
                          ...
                          <span class="data-value"
                            >BTC / bc1q07...683syh<br
                          /></span>
                        </div>
                        <div class="data-col data-col-end">
                          <a
                            class="wd-view-account"
                            href="javascript:void(0);"
                            data-action="profile_account.html"
                            data-modal="wdm-account"
                            ><span class="data-more"
                              ><em class="bx bx-right-arrow-alt"></em></span
                          ></a>
                        </div>
                      </div>
                      <div class="data-item">
                        ...
                        <div class="data-col data-col-end">
                          <a
                            class="wd-view-account"
                            href="javascript:void(0);"
                            data-action="https://app.investorm.xyz/withdraw/account/crypto-withdraw/QnR5UEh0TlhYQTBjUWRpTlQ1ZG9hUT09"
                            data-modal="wdm-account"
                            ><span class="data-more"
                              ><em class=" bx bx-right-arrow-alt "></em></span
                          ></a>
                      ...
                      <div class="data-item">
                        ...
                        <div class="data-col data-col-end">
                          <a
                            ...
                            data-modal="wdm-account"
                            ><span class="data-more"
                              ><em class="icon bx bx-right-arrow-alts"></em></span
                          ></a>
                        </div>
                      </div>
                    </div>
    ...
    <script type="text/javascript">
      const msgs = {
        wdm: {
          ...
          context:
            "The withdraw account will be deleted immediately. You can't undo this action. Are you sure you want to proceed?",
          btn: { confirm: "Delete Account", cancel: "Cancel" },
        },
      };
    </script>
  </body>
