            ...
            <div class="container-xl wide-lg">
              <div class="nk-content-body">
                ...
                <ul class="nk-nav nav nav-tabs">
                  <li class="nav-item">
                    <a class="nav-link" href="transactions.html">History</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" href="transactions_deposit.html"
                      >Deposit</a
                    >
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="transactions_withdraw.html"
                      >Withdraw</a
                    >
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="transactions_scheduled.html">
