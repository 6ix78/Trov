    ...
    <div class="nk-pps-result">
        ...
        <div class="nk-pps-action">
            <ul class="btn-group-vertical align-center gy-3">
                <li><a href="https://app.investorm.xyz/withdraw" class="btn btn-lg btn-mw btn-primary">Another Withdraw</a></li>
                <li><a href="https://app.investorm.xyz/transactions" class="link link-primary">Check status in Transaction</a></li>
            </ul>
        </div>
    </div>
</div>
