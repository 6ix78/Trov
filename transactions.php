                    ...
                    <div class="nk-odr-item">
                      <div class="nk-odr-col">
                        <div class="nk-odr-info">
                          <div class="nk-odr-badge">
                            <span
                              class="nk-odr-icon bg-purple-dim text-purple icon ni ni-exchange"
                            ></span>
                          </div>
                      ...
                      <div class="nk-odr-col nk-odr-col-amount">
                        <div class="nk-odr-amount">
                          <div class="number-md text-s text-danger">
                            - 250.00
                            <span class="currency">USD</span>
                          </div>
                          <div class="number-sm">
                            250.00 <span class="currency">USD</span>
                          </div>
                        </div>
                      </div>
                      <div class="nk-odr-col nk-odr-col-action">
                        <div class="nk-odr-action">
                          <a
                            ...
                            data-tnx="Mzlid3RuL2ptMzhTdndhaHdTdkFaZz09"
                      ...
                      <div class="nk-odr-col nk-odr-col-action">
                        <div class="nk-odr-action">
                          <a
                            class="tnx-details"
                            href="javascript:void(0)"
                            data-tnx="SmcyWURCK0hWaEhQZ0pnanRBVERzUT09"
                            ><em class="icon ni ni-forward-ios"></em
                          ></a>
                        </div>
                      </div>
                    ...
                    <div class="nk-odr-item">
                      <div class="nk-odr-col">
                        <div class="nk-odr-info">
                          <div class="nk-odr-badge">
                            <span
                              class="nk-odr-icon bg-success-dim text-success icon ni ni-arrow-to-right"
                            ></span>
                          </div>
                          <div class="nk-odr-data">
                            <div class="nk-odr-label">
                      ...
                      <div class="nk-odr-col nk-odr-col-action">
                        <div class="nk-odr-action">
                          <a
                            class="tnx-details"
                            href="javascript:void(0)"
                            data-tnx="T3l6aGpGT2FETmRBaXV6RDlPazA4QT09"
                            ><em class="icon ni ni-forward-ios"></em
                          ></a>
                        </div>
                      </div>
