...
<body>
  ...
  <div class="page-loading active">
    <div class="page-loading-inner">
      ...
      <img src="" alt=""><span>Evercore Loading...</span>
    </div>
  </div>
        ...
        <div class="row flex-lg-nowrap">
          ...
          <div class="col-lg-6 col-xl-5  text-lg-start pt-5 pl-20 mt-xl-4">
            <div>
              ...
              <span> <a href="user_login.php"> Sign In </a></span>
            </div><br>
            <div>
              <section class="signup form">
                <form action="" method="POST" enctype="multipart/form-data" autocomplete="off">
                  ...
                  <div class="row">
                    ...
                    <div class="col-12 mb-4">
                      ...
                      <div class="password-toggle">
                        ...
                        <input type="number" id="" name="ref_code" class="form-control form-control-lg" value="" hidden>
                        <label class="password-toggle-btn" aria-label="Show/hide password">
                          <input class="password-toggle-check" type="checkbox">
                          <span class="password-toggle-indicator"></span>
                        </label>
                  ...
                  <div class="button">
                    <input type="submit" name="submit" value="Sign up" class="btn btn-danger shadow-primary btn-lg w-100">
                  </div>
                </form>
              </section>
              <!-- Default modal -->
