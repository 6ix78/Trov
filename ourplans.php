              ...
              <div class="nk-content-body">
                <div class="nk-block-head text-center">
                  ...
                  <div class="nk-block-des w-max-550px m-auto">
                    <p class="lead">
                      Here is our several investment plans. You can invest
                      daily, weekly or monthly and get higher returns in your
                      investment.
                    </p>
                    <p>
                      <strong
                        >Choose your favourite plan and start earning
                        now.</strong
                      >
                    </p>
                  </div>
                ...
                <div class="nk-ivp-apps">
                  <div
                    class="nk-ivp-plans row g-gs scheme-container justify-center"
                  >
                                ...
                                <li>
                                  <span class="label"
                                    ...
                                    <em
                                      ...
                                      title="The invested amount will be return at the end of term."
                                    ></em
                                  ></span>
                                  - <span class="data"> Each Term </span>
                                </li>
                              </ul>
                            ...
                            <div class="card-text">
                              <ul class="nk-ivp-data">
                                ...
                                <li>
                                  ...
                                  <span class="data">500.00 USD</span>
                                </li>
                                <li>
                                  <span class="label"
                                    >Capital Return
                          ...
                          <div class="card-inner">
                            <div class="card-text">
                              <ul class="nk-ivp-data">
                                ...
                                <li>
                                  <span class="label">Max Deposit</span> -
                                  <span class="data">1,500.00 USD</span>
                                </li>
                                <li>
                                  <span class="label"
                                    >Capital Return
                          ...
                          <div class="card-inner">
                            <div class="card-text">
                              <ul class="nk-ivp-data">
                                ...
                                <li>
                                  <span class="label">Max Deposit</span> -
                                  <span class="data">2,500.00 USD</span>
                                </li>
                                <li>
                                  <span class="label"
                                    >Capital Return
                          ...
                          <div class="card-inner">
                            <div class="card-text">
                              <ul class="nk-ivp-data">
                                ...
                                <li>
                                  <span class="label">Max Deposit</span> -
                                  <span class="data">1,000.00 USD</span>
                                </li>
                                <li>
                                  <span class="label"
                                    >Capital Return
