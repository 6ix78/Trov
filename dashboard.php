              ...
              <div class="nk-sidebar-content">
                ...
                <div class="nk-sidebar-widget nk-sidebar-widget-full d-xl-none pt-0">
                  ...
                  <div class="nk-profile-content toggle-expand-content" data-content="sidebarProfile">
                    ...
                    <ul class="link-list">
                      <li>
                        <a href="php/logout.php"><em class="icon bx bx-log-out-circle"></em><span>Sign out</span></a>
                      </li>
                      <li>
                        <form action="php/delete.php" method="post">
                          <input type="text" value="<?php echo $ref ?>" name="ref_id" hidden>
                          <button style="border: none; background-color: transparent;"><em class="icon bx bx-x-circle"></em><span>Delete</span></button>
                ...
                <div class="nk-block-between-md g-4">
                  ...
                  <div class="nk-block-head-content d-none d-md-inline-flex">
                    <ul class="nk-block-tools gx-3">
                      <li>
                        <a href="ourplans.php?ref=<?php echo $row['ref_id'] ?>" class="btn btn-secondary"><span>Invest &amp; Earn</span>
                          <em class="icon bx bx-right-arrow-alt d-none d-lg-inline-block"></em></a>
                      </li>
                      <li>
                        <a href="deposit.php?ref=<?php echo $row['ref_id'] ?>" class="btn btn-danger"><span>Deposit</span>
                          <em class="icon bx bx-right-arrow-alt"></em></a>
                      </li>
                    </ul>
                  </div>
                </div>
                      ...
                      <div class="card-inner">
                        <div class="card-title-group">
                          ...
                          <div class="card-tools">
                            <em class="icon bx bx-info-circle fs-13px text-soft nk-tooltip" title="Main account balance without locked or under progress."></em>
                          </div>
                        </div>
                        <div class="card-amount mt-2 mb-1">
                          <span class="amount"><?php echo $row['balance']; ?> <span class="currency">USD</span></span>
                        </div>
                          ...
                          <div class="card-stats-group g-2">
                            <div class="card-stats-data">
                              <div class="title fw-bold">
                                Investment Account
                                <em class="icon bx bx-info-circle fs-12px text-soft nk-tooltip" title="Additional balance in your Investment account."></em>
                              </div>
                        ...
                        <div class="card-action d-md-none">
                          <ul class="nk-block-tools g-3 flex-wrap flex-sm-nowrap">
                            ...
                            <li>
                              <a href="ourplans.php?ref=<?php echo $row['ref_id'] ?>" class="btn btn-secondary"><span>Invest &amp; Earn</span>
                                <em class="icon bx bx-right-arrow-alt d-none d-sm-inline-block"></em></a>
                            </li>
                          </ul>
                        </div>
                      </div>
                    ...
                    <div class="card card-full card-bordered card-wg on-bottom is-base">
                      <div class="card-inner">
                        <div class="card-title-group">
                          ...
                          <div class="card-tools">
                            <em class="icon bx bx-info-circle fs-13px text-soft nk-tooltip" title="The total Deposit amount without under progress."></em>
                          </div>
                        </div>
                        <div class="card-amount mt-2 mb-1">
                        ...
                        <div class="card-stats">
                          <div class="card-stats-group g-2">
                            <div class="card-stats-data">
                              ...
                              <div class="amount fw-bold">
                                0 <span class="currency fw-normal">USD</span>
                                <span class="change down tipinfo" title="Than last month">
                                  <em class="icon bx bx-down-arrow-alt"></em>100%
                                </span>
                              </div>
                            </div>
                          </div>
                  ...
                  <div class="card card-full card-bordered card-wg on-bottom is-warning">
                    <div class="card-inner">
                      <div class="card-title-group">
                        ...
                        <div class="card-tools">
                          <em class="icon bx bx-info-circle fs-13px text-soft nk-tooltip" title="The total Withdraw amount without under progress."></em>
                        </div>
                      </div>
                      <div class="card-amount mt-2 mb-1">
                        <span class="amount">0 <span class="currency">USD</span></span>
              ...
              <div class="nk-block nk-block-lg">
                <div class="nk-block-head-sm">
                  <div class="nk-block-between-md g-4">
                    ...
                    <div class="nk-block-head-content">
                      <a href="transactions.php?ref=<?php echo $row['ref_id'] ?>">See History</a>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="nk-odr-col">
                      <div class="nk-odr-info">
                        <div class="nk-odr-badge">
                          <span class="nk-odr-icon bg-success-dim text-success icon ic bx bx-arrow-to-right "></span>
                        </div>
                      ...
                      <div class="nk-refwg-invite">
                        ...
                        <div class="nk-refwg-url">
                          <div class="form-control-wrap">
                            ...
                            <input type="text" class="form-control copy-text" id="ref-url" value="http://localhost/investorm/register.php?ref=<?php echo $ref ?>" />
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <div class="nk-footer-wrap">
            ...
            <div class="nk-footer-links">
              <ul class="nav nav-sm">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="h#terms-and-condition">Terms and Condition</a>
                </li>
                <li class="nav-item">
