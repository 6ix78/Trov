          ...
          <div class="row flex-lg-nowrap">
            ...
            <?php  } ?>
                    <div class="col-12 mb-4">
                      <label for="password-confirm" class="form-label fs-base">New Password </label>
                      <div class="password-toggle">
                        <input type="password" id="password-confirm" name="password" class="form-control form-control-lg">
                      ...
                      <div class="password-toggle">
                        <input type="password" id="password-confirm" name="cpassword" class="form-control form-control-lg">
                       ...
                       <br>
                            ...
                            <div>
                                <button type="submit" name="new_pass" class="btn btn-danger shadow-primary btn-lg w-100">Update Password </button>
