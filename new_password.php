...
<html lang="zxx" class="js">
    <head> <meta charset="utf-8">
        ...
        <meta name="description" content="A powerful and conceptual apps base dashboard template that especially build for developers and programmers."><link rel="shortcut icon" href="asset/img/favicon.png"><title>Create New Password | EVERCORE FINANCE</title><link id="skin-default" rel="stylesheet" href="asset/test1.css">
    ...
    <body class="nk-body bg-white npc-general pg-auth" >
        <div class="nk-app-root"><div class="nk-main ">
            ...
            <div class="nk-split-content nk-block-area nk-block-area-column nk-auth-container bg-white w-lg-45"><div class="absolute-top-right d-lg-none p-3 p-sm-5"><a href="#" class="toggle btn btn-white btn-icon btn-light" data-target="athPromo"><em class="icon bx bx-info-circle"></em></a></div><div class="nk-block nk-block-middle nk-auth-body"><div class="brand-logo pb-5"><a href="login.html" class="logo-link"><img class="logo-light logo-img logo-img-lg" src="asset/img/logo-dark.png" ><img class="logo-dark logo-img logo-img-lg" src="asset/img/logo-dark.png" ></a></div><div class="nk-block-head"><div class="nk-block-head-content"><h5 class="nk-block-title">New Password </h5><div class="nk-block-des"><p></p></div></div></div>
            <?php if (isset($_GET['error'])) { ?>
              <p class="error"> <?php echo $_GET['error']; ?></p>
            <?php  } ?>
            <form action="php/otp.php" method="post">
                <div class="form-group"><div class="form-control-wrap">
                    <input type="text" class="form-control form-control-lg" name="password" placeholder="Create New Password"></div></div>
                <div class="form-group"><div class="form-control-wrap">
                    <input type="text" class="form-control form-control-lg" name="cpassword" placeholder="Confirm Password "></div></div>
                    <div class="form-group"><button name="change-password" class="btn btn-lg btn-danger btn-block">Change</button></div>
            </form>
