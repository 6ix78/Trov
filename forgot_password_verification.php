        ...
        <div class="nk-app-root"><div class="nk-main ">
            ...
            <form action="php/otp.php" method="post">
                <div class="form-group"><div class="form-control-wrap">
                    <input type="number" class="form-control form-control-lg" name="otp" placeholder="Enter Otp "></div></div>
                    <div class="form-group"><button name="check-reset-otp" class="btn btn-lg btn-danger btn-block">Submit</button></div>
            </form>
